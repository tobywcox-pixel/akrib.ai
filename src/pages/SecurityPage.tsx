      ...
      <main className="pt-32 pb-24 px-6">
        <div className="max-w-3xl mx-auto">
          <motion.div 
            ...
            className="mb-16"
          >
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-brand-surface border border-zinc-800 rounded-full text-xs font-semibold text-brand-muted mb-8">
          ...
          <div className="prose prose-zinc prose-invert max-w-none space-y-12 text-brand-muted font-medium leading-relaxed">
            <section>
              <h2 className="text-2xl font-bold text-brand-black mb-4">1. UK-Only Sovereign Hosting</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-bold text-brand-black mb-4">2. Encryption Standards</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-bold text-brand-black mb-4">3. Access Controls</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-bold text-brand-black mb-4">4. Continuous Monitoring</h2>
              <p>
