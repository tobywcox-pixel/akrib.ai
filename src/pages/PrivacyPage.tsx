      ...
      <main className="pt-32 pb-24 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-zinc prose-invert max-w-none space-y-12 text-brand-muted font-medium leading-relaxed">
            <section>
              <h2 className="text-2xl font-bold text-brand-black mb-4">1. Data Sovereignty</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-bold text-brand-black mb-4">2. Information Collection</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-bold text-brand-black mb-4">3. Data Usage</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-bold text-brand-black mb-4">4. Security Measures</h2>
              <p>
